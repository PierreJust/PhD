...
print("for mitochondrial haplogroup clustering, select number of the mitochondrial column: (for us) type 3")
arg1=int(input())
print("for Y chromosome haplogroup clustering, select number of the Y chromosome column: (for us) type 5")
arg2=int(input())
print("for mitochondrial sub haplogroup clustering, select the number of the mitochondrial column: (for us) type 4")
arg3=int(input())
print("for Y chromosome sub haplogroup clustering, select the number of the Y chromosome column: (for us) type 6")
arg4=int(input())
print("for archaeological culture clustering, select the number of the archaeological culture column (for us) type 1")
arg5=int(input())
print("for country, select the number of the country column (for us) type 10")
arg6=int(input())
...
outfile_edgeList=open("networkGCC.txt","w")
